...
```
    ...
    ## Moderation results
    ## ---------------------------------------------------------------------
    ## Moderation     k  n       OR [95% CI] Estimate   SE R2(2) R2(3)     p
    ## ---------------------------------------------------------------------
    ## Baseline      21 66 0.90 [0.84, 0.98]     0.90 0.04     -     -     -
    ## Proposal type 21 66                 -        -    -  0.07  0.79 0.004
    ##   Intercept    -  - 0.99 [0.92, 1.07]     0.99 0.04     -     -     -
    ##   Fellowship  11 26 0.82 [0.74, 0.91]     0.82 0.05     -     -     -
    ## ---------------------------------------------------------------------
...
```
    ...
    ## ------------------------------------------------------------------------------------
    ## Baseline                     21 66 0.90 [0.84, 0.98]     0.90 0.04     -     -     -
    ## Type                         21 66                 -        -    -  0.07  0.79 0.004
    ##   Intercept                   -  - 0.99 [0.92, 1.07]     0.99 0.04     -     -     -
    ##   Fellowship                 11 26 0.82 [0.74, 0.91]     0.82 0.05     -     -     -
    ## Discipline                   21 66                 -        -    -  0.00  0.50  0.13
    ##   Intercept                   -  - 0.98 [0.84, 1.13]     0.98 0.08     -     -     -
    ##   Life sciences/biology      12 26 0.89 [0.76, 1.05]     0.89 0.08     -     -     -
    ##   Social sciences/humanities  5 13 0.80 [0.64, 1.00]     0.80 0.11     -     -     -
    ##   Multidisciplinary           5 13 1.01 [0.83, 1.23]     1.01 0.10     -     -     -
    ## Country                      21 66                 -        -    -  0.12  0.66 0.020
    ##   Intercept                   -  - 1.00 [0.89, 1.13]     1.00 0.06     -     -     -
    ##   Canada                      1  3 0.87 [0.69, 1.10]     0.87 0.12     -     -     -
    ##   Australia                   5 13 0.98 [0.79, 1.21]     0.98 0.11     -     -     -
    ##   United Kingdom              4 10 1.06 [0.87, 1.28]     1.06 0.10     -     -     -
    ##   Europe                      7 28 0.80 [0.69, 0.93]     0.80 0.07     -     -     -
    ## ------------------------------------------------------------------------------------
...
```
    ...
    ## Baseline                     21 66 0.90 [0.84, 0.98]     0.90 0.04     -     -     -
    ## Type                         21 66                 -        -    -  0.07  0.79 0.004
    ##   Grant                      13 40 0.99 [0.92, 1.07]     0.99 0.04     -     -     -
    ##   Fellowship                 11 26 0.82 [0.76, 0.88]     0.82 0.04     -     -     -
    ## Discipline                   21 66                 -        -    -  0.00  0.50  0.13
    ##   Physical sciences           5 14 0.98 [0.84, 1.13]     0.98 0.08     -     -     -
    ##   Life sciences/biology      12 26 0.87 [0.80, 0.95]     0.87 0.04     -     -     -
    ##   Social sciences/humanities  5 13 0.78 [0.64, 0.95]     0.78 0.10     -     -     -
    ##   Multidisciplinary           5 13 0.99 [0.87, 1.12]     0.99 0.06     -     -     -
    ## Country                      21 66                 -        -    -  0.12  0.66 0.020
    ##   United States               4 12 1.00 [0.89, 1.13]     1.00 0.06     -     -     -
    ##   Canada                      1  3 0.88 [0.72, 1.07]     0.88 0.10     -     -     -
    ##   Australia                   5 13 0.98 [0.82, 1.17]     0.98 0.09     -     -     -
    ##   United Kingdom              4 10 1.06 [0.91, 1.24]     1.06 0.08     -     -     -
    ##   Europe                      7 28 0.80 [0.73, 0.89]     0.80 0.05     -     -     -
    ## ------------------------------------------------------------------------------------
...
(*R*<sub>(2)</sub><sup>2</sup> = 6.93%; *R*<sub>(3)</sub><sup>2</sup> =
79.43%), and ‘Country’ (*R*<sub>(2)</sub><sup>2</sup> = 12.09%;
*R*<sub>(3)</sub><sup>2</sup> = 66.06%).”
...
``` r
moderation_object2 |> 
  papaja::apa_table(caption = "Moderation table created with apa_table")
```
...
![](README_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->
    ...
    ## Limit Estimate (as sei -> 0):   b = -0.0122 (CI: -0.0880, 0.0637)
